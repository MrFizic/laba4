...
if __name__ == "__main__":
    ...
    print("Addition:", calc.perform_operation('addition', a, b))
    print("Subtraction:", calc.perform_operation('subtraction', a, b))
    print("Multiplication:", calc.perform_operation('multiplication', a, b))
